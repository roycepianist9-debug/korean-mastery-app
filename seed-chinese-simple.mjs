...
// HSK Level 1 vocabulary with pre-matched example sentences
...
async function seedChinese() {
  ...
  try {
    ...
    for (const word of chineseVocabulary) {
      try {
        const query = `INSERT INTO words (language, chinese, pinyin, pos, meaning, hskLevel, chineseExample, examplePinyin) VALUES (?, ?, ?, ?, ?, ?, ?, ?)`;
