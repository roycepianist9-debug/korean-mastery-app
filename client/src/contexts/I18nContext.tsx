...
const translations = {
  en: {
    ...
    "swipe.jlptLevel": "JLPT Level",
    "swipe.hskLevel": "HSK Level",
    ...
    "swipe.levelProgress": "Level {{level}} → {{next}}",
    "swipe.master": "MASTER",
    "swipe.beginner": "Beginner",
    "swipe.intermediate": "Intermediate",
    "swipe.advanced": "Advanced",
    "swipe.nativeLike": "Native-like",
    "swipe.noun": "Noun",
    "swipe.verb": "Verb",
    "swipe.adjective": "Adjective",
    "swipe.adverb": "Adverb",
    "swipe.determiner": "Determiner",
    "swipe.interjection": "Interjection",
    "swipe.allLevels": "All Levels",
    "swipe.allTypes": "All Types",
    "swipe.understanding": "Basic Understanding",
    "swipe.conversational": "Conversational Fluency",
    "swipe.comprehension": "Advanced Comprehension",
    "swipe.professional": "Professional Proficiency",
    "swipe.advancedProf": "Advanced Proficiency",
    "swipe.nativeFluentcy": "Near-Native Fluency",
    "swipe.elementary": "Elementary",
    "swipe.elementaryPlus": "Elementary+",
    "swipe.intermediatePlus": "Intermediate+",
    "swipe.advancedFluency": "Advanced Fluency",
    "swipe.nativeProficiency": "Near-Native Proficiency",
    ...
    // Guest landing intro
    "landing.tagline": "Master languages naturally.",
    "landing.subtitle": "39,000+ curated words",
    "landing.features": "Swipe • Memory • Progression • Real retention",
    "landing.tryInstantly": "Try instantly — no signup required",
    "landing.startKorean": "Start Korean",
    "landing.startChinese": "Start Chinese",
    "landing.startJapanese": "Start Japanese",
    "landing.learnLikeGame": "Learn like a game",
    "landing.dailyStreaks": "Daily streaks",
    "landing.xpProgression": "XP & progression",
    "landing.memoryTraining": "Memory training",
    "landing.unlockNewLevels": "Unlock new levels",
    "landing.roadmap": "HSK / TOPIK roadmap",
    "landing.yourJourney": "Your language journey",
    "landing.free": "Free",
    "landing.preview": "Preview",
    "landing.premium": "Premium",
    "landing.freeAccess": "Free access includes",
    "landing.beginnerCards": "300 beginner cards",
    "landing.memoryMode": "Memory mode",
    "landing.previewCards": "10 preview cards for every advanced level",
    "landing.unlockPremium": "Unlock Premium",
    "landing.fullLibrary": "Full 39,000+ card library",
    "landing.unlimitedLevels": "Unlimited advanced levels",
    "landing.crossDeviceSync": "Cross-device sync",
    "landing.leaderboards": "Leaderboards & stats",
    "landing.futureAI": "Future AI features",
    "landing.unlockFullAccess": "Unlock Full Access",
    "landing.taglineBottom": "Small daily progress becomes fluency.",
  },
  fr: {
    // Navigation
    "nav.home": "Accueil",
    ...
    "swipe.jlptLevel": "Niveau JLPT",
    "swipe.hskLevel": "Niveau HSK",
    ...
    "swipe.levelProgress": "Niveau {{level}} → {{next}}",
    "swipe.master": "MAÎTRE",
    "swipe.beginner": "Débutant",
    "swipe.intermediate": "Intermédiaire",
    "swipe.advanced": "Avancé",
    "swipe.nativeLike": "Niveau natif",
    "swipe.noun": "Nom",
    "swipe.verb": "Verbe",
    "swipe.adjective": "Adjectif",
    "swipe.adverb": "Adverbe",
    "swipe.determiner": "Déterminant",
    "swipe.interjection": "Interjection",
    "swipe.allLevels": "Tous les niveaux",
    "swipe.allTypes": "Tous les types",
    "swipe.understanding": "Compréhension de base",
    "swipe.conversational": "Fluidité conversationnelle",
    "swipe.comprehension": "Compréhension avancée",
    "swipe.professional": "Compétence professionnelle",
    "swipe.advancedProf": "Compétence avancée",
    "swipe.nativeFluentcy": "Fluidité quasi-native",
    "swipe.elementary": "Élémentaire",
    "swipe.elementaryPlus": "Élémentaire+",
    "swipe.intermediatePlus": "Intermédiaire+",
    "swipe.advancedFluency": "Fluidité avancée",
    "swipe.nativeProficiency": "Compétence quasi-native",
    ...
    // Guest landing intro
    "landing.tagline": "Maîtrisez les langues naturellement.",
    "landing.subtitle": "39 000+ mots sélectionnés",
    "landing.features": "Swipe • Mémoire • Progression • Rétention réelle",
    "landing.tryInstantly": "Essayez instantanément — pas d'inscription requise",
    "landing.startKorean": "Commencer le coréen",
    "landing.startChinese": "Commencer le chinois",
    "landing.startJapanese": "Commencer le japonais",
    "landing.learnLikeGame": "Apprendre comme un jeu",
    "landing.dailyStreaks": "Séries quotidiennes",
    "landing.xpProgression": "XP et progression",
    "landing.memoryTraining": "Entraînement mémoire",
    "landing.unlockNewLevels": "Débloquer de nouveaux niveaux",
    "landing.roadmap": "Feuille de route HSK / TOPIK",
    "landing.yourJourney": "Votre parcours linguistique",
    "landing.free": "Gratuit",
    "landing.preview": "Aperçu",
    "landing.premium": "Premium",
    "landing.freeAccess": "L'accès gratuit comprend",
    "landing.beginnerCards": "300 cartes pour débutants",
    "landing.memoryMode": "Mode mémoire",
    "landing.previewCards": "10 cartes d'aperçu pour chaque niveau avancé",
    "landing.unlockPremium": "Débloquer Premium",
    "landing.fullLibrary": "Bibliothèque complète de 39 000+ cartes",
    "landing.unlimitedLevels": "Niveaux avancés illimités",
    "landing.crossDeviceSync": "Synchronisation multi-appareils",
    "landing.leaderboards": "Classements et statistiques",
    "landing.futureAI": "Fonctionnalités IA futures",
    "landing.unlockFullAccess": "Débloquer l'accès complet",
    "landing.taglineBottom": "Les petits progrès quotidiens deviennent la fluidité.",
  },
} as const;
